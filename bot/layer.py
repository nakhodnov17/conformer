...
from feedforward import ConformerFeedForward
from convolution import ConformerConvolution
...
class ConformerLayer(torch.nn.Module):
    ...
    def forward(self, x, att_mask=None, pos_emb=None, pad_mask=None):
        ...
        res = self.self_attn(res, res, res, att_mask,
                             pos_emb)  # Multi-Head Attention with Relative Positional Embedding
