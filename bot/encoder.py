...
from layer import ConformerLayer
from preprocessor import ConvSubsampling
from encoding import RelPositionalEncoding
...
class ConformerEncoder(torch.nn.Module):
    def __init__(
        ...
        ### YOUR CODE HERE
        self.pos_enc = RelPositionalEncoding(d_model, dropout_pre_encoder, pos_emb_max_len, xscale=True,
        ...
        for i in range(n_layers):
            layers.append(
                ConformerLayer(d_model, d_model * ff_expansion_factor, n_heads, conv_kernel_size, dropout, dropout_att))
